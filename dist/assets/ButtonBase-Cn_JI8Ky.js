...
`),m.rippleVisible,bt,ie,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,gt,ie,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,yt,({theme:e})=>e.transitions.easing.easeInOut),Mt=o.forwardRef(function(t,n){const u=Te({props:t,name:"MuiTouchRipple"}),{center:r=!1,classes:i={},className:s}=u,c=oe(u,ht),[l,p]=o.useState([]),d=o.useRef(0),g=o.useRef(null);o.useEffect(()=>{g.current&&(g.current(),g.current=null)},[l]);const b=o.useRef(!1),C=Ze(),h=o.useRef(null),y=o.useRef(null),U=o.useCallback(f=>{const{pulsate:R,rippleX:E,rippleY:B,rippleSize:O,cb:$}=f;p(M=>[...M,N.jsx(Et,{classes:{ripple:x(i.ripple,m.ripple),rippleVisible:x(i.rippleVisible,m.rippleVisible),ripplePulsate:x(i.ripplePulsate,m.ripplePulsate),child:x(i.child,m.child),childLeaving:x(i.childLeaving,m.childLeaving),childPulsate:x(i.childPulsate,m.childPulsate)},timeout:ie,pulsate:R,rippleX:E,rippleY:B,rippleSize:O},d.current)]),d.current+=1,g.current=$},[i]),S=o.useCallback((f={},R={},E=()=>{})=>{const{pulsate:B=!1,center:O=r||R.pulsate,fakeElement:$=!1}=R;if((f==null?void 0:f.type)==="mousedown"&&b.current){b.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(b.current=!0);const M=$?null:y.current,P=M?M.getBoundingClientRect():{width:0,height:0,left:0,top:0};let v,L,D;if(O||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)v=Math.round(P.width/2),L=Math.round(P.height/2);else{const{clientX:I,clientY:V}=f.touches&&f.touches.length>0?f.touches[0]:f;v=Math.round(I-P.left),L=Math.round(V-P.top)}if(O)D=Math.sqrt((2*P.width**2+P.height**2)/3),D%2===0&&(D+=1);else{const I=Math.max(Math.abs((M?M.clientWidth:0)-v),v)*2+2,V=Math.max(Math.abs((M?M.clientHeight:0)-L),L)*2+2;D=Math.sqrt(I**2+V**2)}f!=null&&f.touches?h.current===null&&(h.current=()=>{U({pulsate:B,rippleX:v,rippleY:L,rippleSize:D,cb:E})},C.start(mt,()=>{h.current&&(h.current(),h.current=null)})):U({pulsate:B,rippleX:v,rippleY:L,rippleSize:D,cb:E})},[r,U,C]),_=o.useCallback(()=>{S({},{pulsate:!0})},[S]),j=o.useCallback((f,R)=>{if(C.clear(),(f==null?void 0:f.type)==="touchend"&&h.current){h.current(),h.current=null,C.start(0,()=>{j(f,R)});return}h.current=null,p(E=>E.length>0?E.slice(1):E),g.current=R},[C]);return o.useImperativeHandle(n,()=>({pulsate:_,start:S,stop:j}),[_,S,j]),N.jsx(Rt,X({className:x(m.root,i.root,s),ref:y},c,{children:N.jsx(le,{component:null,exit:!0,children:l})}))});function Tt(e){return Ae("MuiButtonBase",e)}const xt=Me("MuiButtonBase",["root","disabled","focusVisible"]),Ct=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],vt=e=>{const{disabled:t,focusVisible:n,focusVisibleClassName:u,classes:r}=e,s=Xe({root:["root",t&&"disabled",n&&"focusVisible"]},Tt,r);return n&&u&&(s.root+=` ${u}`),s},Vt=ae("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${xt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),Lt=o.forwardRef(function(t,n){const u=Te({props:t,name:"MuiButtonBase"}),{action:r,centerRipple:i=!1,children:s,className:c,component:l="button",disabled:p=!1,disableRipple:d=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:C="a",onBlur:h,onClick:y,onContextMenu:U,onDragLeave:S,onFocus:_,onFocusVisible:j,onKeyDown:f,onKeyUp:R,onMouseDown:E,onMouseLeave:B,onMouseUp:O,onTouchEnd:$,onTouchMove:M,onTouchStart:P,tabIndex:v=0,TouchRippleProps:L,touchRippleRef:D,type:I}=u,V=oe(u,Ct),K=o.useRef(null),T=o.useRef(null),xe=he(T,D),{isFocusVisibleRef:ce,onFocus:Ce,onBlur:ve,ref:Ve}=ot(),[F,Y]=o.useState(!1);p&&F&&Y(!1),o.useImperativeHandle(r,()=>({focusVisible:()=>{Y(!0),K.current.focus()}}),[]);const[J,we]=o.useState(!1);o.useEffect(()=>{we(!0)},[]);const Pe=J&&!d&&!p;o.useEffect(()=>{F&&b&&!d&&J&&T.current.pulsate()},[d,b,F,J]);function w(a,fe,ze=g){return H(de=>(fe&&fe(de),!ze&&T.current&&T.current[a](de),!0))}const Le=w("start",E),De=w("stop",U),Be=w("stop",S),Ie=w("stop",O),Fe=w("stop",a=>{F&&a.preventDefault(),B&&B(a)}),ke=w("start",P),Ne=w("stop",$),Se=w("stop",M),je=w("stop",a=>{ve(a),ce.current===!1&&Y(!1),h&&h(a)},!1),Oe=H(a=>{K.current||(K.current=a.currentTarget),Ce(a),ce.current===!0&&(Y(!0),j&&j(a)),_&&_(a)}),Q=()=>{const a=K.current;return l&&l!=="button"&&!(a.tagName==="A"&&a.href)},ee=o.useRef(!1),Ue=H(a=>{b&&!ee.current&&F&&T.current&&a.key===" "&&(ee.current=!0,T.current.stop(a,()=>{T.current.start(a)})),a.target===a.currentTarget&&Q()&&a.key===" "&&a.preventDefault(),f&&f(a),a.target===a.currentTarget&&Q()&&a.key==="Enter"&&!p&&(a.preventDefault(),y&&y(a))}),_e=H(a=>{b&&a.key===" "&&T.current&&F&&!a.defaultPrevented&&(ee.current=!1,T.current.stop(a,()=>{T.current.pulsate(a)})),R&&R(a),y&&a.target===a.currentTarget&&Q()&&a.key===" "&&!a.defaultPrevented&&y(a)});let W=l;W==="button"&&(V.href||V.to)&&(W=C);const z={};W==="button"?(z.type=I===void 0?"button":I,z.disabled=p):(!V.href&&!V.to&&(z.role="button"),p&&(z["aria-disabled"]=p));const $e=he(n,Ve,K),pe=X({},u,{centerRipple:i,component:l,disabled:p,disableRipple:d,disableTouchRipple:g,focusRipple:b,tabIndex:v,focusVisible:F}),Ke=vt(pe);return N.jsxs(Vt,X({as:W,className:x(Ke.root,c),ownerState:pe,onBlur:je,onClick:y,onContextMenu:De,onFocus:Oe,onKeyDown:Ue,onKeyUp:_e,onMouseDown:Le,onMouseLeave:Fe,onMouseUp:Ie,onDragLeave:Be,onTouchEnd:Ne,onTouchMove:Se,onTouchStart:ke,ref:$e,tabIndex:p?-1:v,type:I},z,V,{children:[s,Pe?N.jsx(Mt,X({ref:xe,center:i},L)):null]}))});export{Lt as B,G as T,st as _,he as a,He as b,qe as c,Ye as d,Ze as e,ot as f,be as g,We as s,H as u};
